...
function placeXOrO(squareNumber) {
    //This condition  ensures a square hasnt't already been selected.
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //Active player may only be 'X' or 'O's, if not 'X' it must be 'O'
        }
        else {
...
function checkWinConditions() {
    ...
    //This condition chekcs for a tie. If none of the above conditions are met and
    //9 squares are selected, the code executes.
    else if (selectedSquares.length >= 9) {
        //This function playes  the tie game sound.
        audio('./media/tie.mp3');
        //This function sets a 0.3 second timer before resetGame is called.
...
//This function makes our body element temporarily unclickaable.
function disableClick() {
    //This makes our boyd unclickable
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line gives us access to methods and poperties to use on canvas.
    const c = canvas.getContext('2d');
    //This line indicates where the start of a lines x axis is.
    let x1 = coordX1,
        //This line indicates where the start of a lines y axis is.
        y1 = coordY1,
        //Ths line indicates where the end of the lines x axis is.
        x2 = coordX2,
    ...
    function animateLineDrawing() {
        ...
        //This condition is also necessary for the 6, 4, 2 win condition.
        if (x1 <= x2 && y1 >= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y -= 10; }
            if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
